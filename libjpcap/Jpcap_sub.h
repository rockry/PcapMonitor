#ifndef _JPCAP_SUB_H_
#define _JPCAP_SUB_H_
...
#define DeleteLocalRefEx(ref) (*env)->DeleteLocalRef(env,ref)
...
extern jclass JpcapHandler,Packet,DatalinkPacket,EthernetPacket,IPPacket,
       TCPPacket,UDPPacket,ICMPPacket,IPv6Option,ARPPacket,String,Thread,PPPOEPacket,W80211Packet;
...
extern unsigned short in_ipcksum(unsigned short *addr,int len);
