...
import jpcap.packet.wlan.frame.management.element.subelement.HtCapabilityInformation;
import jpcap.packet.wlan.frame.management.element.subelement.McsSupportedSet;
import jpcap.packet.wlan.frame.management.element.subelement.inter.IHtCapabilityInformation;
import jpcap.packet.wlan.frame.management.element.subelement.inter.IMcsSupportedSet;
...
public class HTCapabilitiesElement extends WlanElementAbstr implements IHtCapabilitiesElement {
	...
	public HTCapabilitiesElement(byte[] data) {
		...
		if (data.length == 26) {
			...
			Log.e(JpcapTools.TAG, "Error decoding HT capabilities element");
		}
	}
